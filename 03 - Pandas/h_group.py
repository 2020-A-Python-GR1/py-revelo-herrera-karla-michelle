...
# -*- coding: utf-8 -*-
"""
Created on Fri Aug 21 19:13:27 2020
...
def llenar_valores_vacios(series, tipo):
    ...
    if(lista_valores.empty == True):
        ...
        if(tipo == 'mas_repetido'):            
            ...
            series_valores_llenos = series.fillna(valor_mas_repetido) #se llenan los valores que no esten llenos de la serie con el valor más repetido
            return series_valores_llenos            
